---
title: "Templates FAQ"
description: 'A high-level FAQ about Nuclei Templates'
sidebarTitle: "FAQ"
icon: "block-question"
iconType: "solid"
---
...
<AccordionGroup>
  ...
  <Accordion title="How can I write nuclei templates?" icon="circle-info" iconType="solid">
    We maintain a [template guide](/templates/introduction/) for writing new and custom nuclei templates. We also have [example templates](/template-example/http/base-http) for various modules nuclei supports.
