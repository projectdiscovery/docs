...
[mssql](/templates/protocols/javascript/modules/mssql.md).MSSQLClient
...
- [constructor](/templates/protocols/javascript/modules/mssql.MSSQLClient.md#constructor)

### Methods

- [Connect](/templates/protocols/javascript/modules/mssql.MSSQLClient.md#connect)
- [ConnectWithDB](/templates/protocols/javascript/modules/mssql.MSSQLClient.md#connectwithdb)
- [IsMssql](/templates/protocols/javascript/modules/mssql.MSSQLClient.md#ismssql)

## Constructors

### constructor

• **new MSSQLClient**(): [`MSSQLClient`](/templates/protocols/javascript/modules/mssql.MSSQLClient.md)
