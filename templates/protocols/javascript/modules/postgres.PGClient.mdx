...
[postgres](/templates/protocols/javascript/modules/postgres.md).PGClient
...
- [constructor](/templates/protocols/javascript/modules/postgres.PGClient.md#constructor)

### Methods

- [Connect](/templates/protocols/javascript/modules/postgres.PGClient.md#connect)
- [ConnectWithDB](/templates/protocols/javascript/modules/postgres.PGClient.md#connectwithdb)
- [ExecuteQuery](/templates/protocols/javascript/modules/postgres.PGClient.md#executequery)
- [IsPostgres](/templates/protocols/javascript/modules/postgres.PGClient.md#ispostgres)

## Constructors

### constructor

• **new PGClient**(): [`PGClient`](/templates/protocols/javascript/modules/postgres.PGClient.md)
...
▸ **ExecuteQuery**(`host`, `port`, `username`): [`SQLResult`](/templates/protocols/javascript/modules/postgres.SQLResult.md)
