...
- [Connect](/templates/protocols/javascript/modules/redis.md#connect)
- [GetServerInfo](/templates/protocols/javascript/modules/redis.md#getserverinfo)
- [GetServerInfoAuth](/templates/protocols/javascript/modules/redis.md#getserverinfoauth)
- [IsAuthenticated](/templates/protocols/javascript/modules/redis.md#isauthenticated)
- [RunLuaScript](/templates/protocols/javascript/modules/redis.md#runluascript)
