...
Upgrading to the Pro tier starts at $100/month. Once you upgrade you receive 2000 scan tokens. 

Upgrade options are available after initial purchase with higher token limits, up to 14,000 tokens per month. If your requirements exceed this limit, reach out to us about a Custom contract."

Check out [our Pricing Page](https://projectdiscovery.io/pricing) for more information. 
</Accordion>
...
<Accordion title="How do scan tokens work?">
 ...
 <Accordion title="How do I subscribe to ProjectDiscovery Cloud Platform?">
