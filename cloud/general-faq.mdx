...
You will be notified prior to running a scan if you are likely to exceed your limits for the month. Assets are deduplicated after scan initiation, so a scan can still complete if there are sufficient credits after deduplication. If not, we will scan as many assets as possible before you hit your limit.

Alternatively, you can reconfigure your scan with fewer assets. If you need higher scanning capacity for your workflows, please contact us at [sales@projectdiscovery.io](mailto:sales@projectdiscovery.io).
