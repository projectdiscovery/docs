...
In this example, we'll walk through setting up ProjectDiscovery Cloud Platform (PDCP) to establish this important workflow. You will add assets, configure a Slack integration, and initiate a scan. 
This will ensure that your team can quickly review scan results, and act on any information the scan reveals to defend your infrastructure.
...
In this example we're going to stick with the simplest path and add assets to your PDCP environment by uploading a .TXT file with the domains you want to include for scanning. 
...
<Steps>
  ...
  <Step title="Set your config options">
    Select your preferred configuration options:
     - Auto Discovery is enabled by default, select the toggle to disable if desired.
...
<Steps>
  ...
  <Step title="Add Config to Slack">
    ...
    - *Optional* Provide a username for your Slack configuration 
  </Step>
  <Step title="Select Events">
   Select the Events you would like to trigger notifications from ProjectDiscovery Cloud Platform to your Slack channel. 
  </Step>
