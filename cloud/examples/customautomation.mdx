...
In this use case walk through an example for an organizations to create custom automation. Every organization is unique in their tech stack composition. 
