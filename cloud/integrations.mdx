...
<CardGroup cols={4}>
  ...
  <Card title="Cloudflare" icon="cloudflare" href="#cdn--dns-providers" />
  <Card title="Fastly" icon="bolt" href="#cdn--dns-providers" />
  <Card title="Namecheap" icon="globe" href="#cdn--dns-providers" />
  <Card title="DigitalOcean" icon="digital-ocean" href="#vps--paas-providers" />
  <Card title="Heroku" icon="h" href="#vps--paas-providers" />
  <Card title="Linode" icon="server" href="#vps--paas-providers" />
</CardGroup>
