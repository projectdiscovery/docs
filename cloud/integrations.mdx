...
<Tabs>
  ...
  ```bash
  for role in roles/compute.viewer roles/dns.reader roles/storage.objectViewer roles/run.viewer roles/cloudfunctions.viewer roles/container.viewer roles/browser; do
