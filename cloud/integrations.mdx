...
<CardGroup cols={2}>
  ...
  <Card title="Organization-Level" icon="building">
    ...
    **Configuration:** Provide your numeric `Organization ID` (e.g. `292477584000`).
  </Card>
</CardGroup>

<Warning>
Organization-level enumeration requires roles bound at the organization level. Granting only project-level permissions while providing an Organization ID will result in a **permission denied** error.
</Warning>

##### Multi-Organization Support

You can monitor **multiple GCP organizations** by creating separate integrations with different organization IDs, giving you consolidated asset discovery across all your GCP environments (e.g. production, staging, development).
...
1. **Via Google Cloud Console:**
   ...
   - Click the **All** tab — your Organization ID is displayed next to your organization name
   - Or go to [IAM & Admin > Settings](https://console.cloud.google.com/iam-admin/settings)
...
3. **Via Organization Policies Page:**
   - Navigate to [Organization Policies](https://console.cloud.google.com/iam-admin/orgpolicies) — your Organization ID is in the URL and page header
...
```
projects/123456789/locations/global/workloadIdentityPools/projectdiscovery-pool/providers/projectdiscovery-oidc
```
