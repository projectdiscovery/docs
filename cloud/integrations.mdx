...
<CardGroup cols={4}>
  ...
  <Card title="Cloudflare" icon="cloudflare" href="#cdn-%26-dns-providers">
    
  </Card>
  <Card title="Fastly" icon="bolt" href="#cdn-%26-dns-providers">
    
  </Card>
  <Card title="Namecheap" icon="globe" href="#cdn-%26-dns-providers">
    
  </Card>
  <Card title="DigitalOcean" icon="digital-ocean" href="#vps-%26-paas-providers">
    
  </Card>
  <Card title="Heroku" icon="h" href="#vps-%26-paas-providers">
    
  </Card>
  <Card title="Linode" icon="server" href="#vps-%26-paas-providers">
...
<Card title="Configure GCP Integration" icon="google" color="#4285F4" href="https://cloud.projectdiscovery.io/assets/configure?provider=gcp">
