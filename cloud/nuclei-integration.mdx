---
title: "View Nuclei Results in a Dashboard"
description: "Review your Nuclei results in ProjectDiscovery Cloud Platform"
sidebarTitle: "Scan Result Dashboard"
---

## Scan Result Dashboard (Nuclei Import) 

Nuclei now supports integration with the ProjectDiscovery Cloud Platform to simplify the visualization of Nuclei results and generate swift reports. This highly requested feature from the community enables easier handling of scan results with minimal effort.
