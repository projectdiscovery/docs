...
After walking through this PDCP Free User Guide, if you're interested in joining the waitlist for PDCP Teams [request to be added here](https://projectdiscovery.io/pricing).  