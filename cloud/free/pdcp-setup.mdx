...
<Steps>
  ...
  <Step title="Login to PDCP">
    Open the Profile menu at the top right and select **API Key** to generate an API Key. You can also visit https://cloud.projectdiscovery.io/templates?ref=api_key directly to obtain your API key.
