...
On Scans, the three sections (sub-tabs) offer Scans, Results, and Configurations.
  ...
  - **Configurations** - explore integrations for alerting and ticketing, scan settings, and template options. (Check out the [Integrations page](/cloud/scanning/integrations) for more.) 
...
<img height="300" src="/images/platform/createscan.png" />

For advanced scan configurations, check out [integrations](/cloud/scanning/integrations) we support for tools like Jira, Slack, and more. 
...
Configurations is where all of our great [scanning-based integrations](/cloud/scanning/integrations) are housed. The Configurations section includes individual pages for each category outlined below:
