...
<Note>
Cloud-managed internal scanning with TunnelX is an Enterprise-exclusive feature. Other users can still perform internal scans using the local scanning method described above.
</Note>
...
<img width="800" src="/images/tunnelx-scan-time.png" alt="Internal Scan Option in Scan Settings" />
