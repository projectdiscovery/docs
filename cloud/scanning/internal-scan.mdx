...
1. **Initiate a Scan**:
   ...
   - Or go to the **Scans** menu (https://cloud.projectdiscovery.io/scans) and create a new scan, choose **Internal** followed by the network you want to scan. Similar to how you would run an external scan
