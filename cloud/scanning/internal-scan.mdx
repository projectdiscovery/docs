...
<Note>
  **System Requirements**\
  pd-agent is designed to be lightweight and efficient. Minimum recommended specifications for optimal performance:
...
Before installing pd-agent, you need to create a network in the ProjectDiscovery Cloud Platform. Each network represents a distinct internal environment (e.g., production, staging, office network) and generates a unique agent configuration.
...
<img
  width="800"
  src="/images/Internal_Network_Scan/pdcp-create-network-demo.gif"
...
- Download and configure pd-agent
...
<img
  width="800"
  src="/images/pd-agent-setup-demo.gif"
  alt="Complete pd-agent Setup: Create Network, Install Agent, and Verify Connection"
/>
...
3. **Select Your Network**:
   - In the scan settings, select your internal network from the dropdown
   - This routes the scan through your connected pd-agent
...
<img
  width="800"
  src="/images/pdcp-internal-scan-demo.gif"
  alt="Creating and Running an Internal Scan in PDCP"
/>
