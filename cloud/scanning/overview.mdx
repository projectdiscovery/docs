...
Assets can be added in several ways. Refer to the [Assets documentation](/cloud/assets/overview) for details on adding your Assets through upload, asset discovery, or cloud integrations.
