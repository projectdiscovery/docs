...
Scan results form Nuclei can be connected to ProjectDiscovery Cloud Platform through both the Free and Teams tier. 
 - Check out a [complete walkthrough here](https://docs.projectdiscovery.io/cloud/free/overview). 
 - If you are already a Nuclei user, jump directly to the [connection page.](https://docs.projectdiscovery.io/cloud/free/scan)
