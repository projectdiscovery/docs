...
description: "Browse available projects for Google Summer of Code 2025 with ProjectDiscovery"
...
<Note>
**Custom proposals welcome!** Have your own idea? Discuss it with mentors on [Discord](https://projectdiscovery.io/community) first to ensure it aligns with ProjectDiscovery's goals.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Join Discord" icon="discord" href="https://projectdiscovery.io/community">
...
<Note>
Have questions about any project? Join our [Discord community](https://projectdiscovery.io/community) and ask in the #gsoc channel. Mentors are available to help you understand projects and choose the right one!
</Note>
