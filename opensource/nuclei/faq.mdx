...
<AccordionGroup>
  ...
  Nuclei can be installed with several different options including: Go, Brew, and Dccoker. Check out [the Nuclei install page](/opensource/nuclei/install) for details on all of the options. 
  </Accordion>
