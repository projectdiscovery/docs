...
<Steps>
    ...
    <Step title="Step 2: Installing Nuclei">
        Install Nuclei by following the instructions in the official [Nuclei documentation](https://nuclei.projectdiscovery.io/). You can use package managers or build from source.
    </Step>
