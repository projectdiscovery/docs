...
{/* <Tip> Interested in learning more, visit the [Introduction](/cloud/introduction) for all the details. </Tip> */}
...
<Tip>
    **Next Steps**
    ...
    <CardGroup cols={3}>
        ...
        <Card title="Dive into our cloud platform" icon="square-8" href="/cloud/features">
        </Card>
