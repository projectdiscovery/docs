...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="globe"
    iconType="duotone"
    href="https://github.com/projectdiscovery/chaos"
  >
...
These utilties can be combined with our other tooling based on the [Unix philosophy](https://blog.projectdiscovery.io/how-projectdiscovery-applies-the-unix-philosophy-to-their-tools/) to create pipelines and customize your offensive security or bug bounty hunting program.
