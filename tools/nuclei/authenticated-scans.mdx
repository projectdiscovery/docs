...
domains:
  - scanme.sh
overwrite: true
token: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IlJlcGxhY2VkIiwiaWF0IjoxNTE2MjM5MDIyfQ.ickqPvP5iRdOJ56zMhALhT9JS502gY8hgTDBb07xaNY
```
...
Please note that the header keys are case-sensitive and non-canonicalized, so make sure to use the exact case and format needed.
